...
from atelier.apps.accounts.schemas.user_schema import MessageOut

from atelier.apps.accounts.schemas.address_schema import (
    AddressCreateIn,
    AddressOut,
    AddressUpdateIn,
    
)
from atelier.apps.accounts.services.address_service import (
...
from atelier.apps.core.exceptions.address import AddressNotFound, CannotDeletePreferentialAddress
...
from atelier.apps.core.permissions.auth_classes import ClientOnlyAuth
from atelier.apps.core.schemas.deafult_schema import PageOut
from atelier.apps.core.utils.pagination import PAGE_SIZE_DEFAULT, paginate_queryset
