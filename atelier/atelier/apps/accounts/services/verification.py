...
from atelier.apps.core.tokens.signing import generate_uid_token
...
from atelier.apps.core.exceptions import InvalidToken
from atelier.apps.accounts.repositories.user_repository import activate_user
