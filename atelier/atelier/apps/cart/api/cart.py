...
from atelier.apps.cart.schemas.cart_item_schema import CartItemCreateIn, CartItemUpdateIn
from atelier.apps.cart.schemas.cart_schema import CartOut
from atelier.apps.cart.services.cart_item_service import (
    add_item_to_cart,
    remove_item_from_cart,
    update_cart_item_quantity,
)
from atelier.apps.cart.services.cart_service import clear_cart_for_client, get_cart_for_client
from atelier.apps.core.exceptions.cart_exception import CartItemNotFound, CartNotFound, InsufficientStock
