...
LOCAL_APPS = [
    ...
    "atelier.apps.core",
    "atelier.apps.accounts",
    "atelier.apps.products",
    "atelier.apps.payments",
    "atelier.apps.cart",
...
ROOT_URLCONF = "atelier.config.urls"
...
WSGI_APPLICATION = "atelier.config.wsgi.application"
...
STORAGES = {
    "default": {
        "BACKEND": "atelier.config.storages.MediaFilesStorage",
    },
    "staticfiles": {
